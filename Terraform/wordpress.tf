...
resource "aws_instance" "database_access_instance" {
  ami           = "ami-04e5276ebb8451442"  # Choose appropriate AMI
  instance_type = "t2.micro"      # Choose appropriate instance type
  subnet_id     = aws_subnet.public_subnet_2.id  # Public subnet ID
...
resource "aws_launch_template" "default" {
  ...
  image_id      = "ami-04e5276ebb8451442"  # Replace with your AMI ID
